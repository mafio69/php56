...
{{ Form::open(array('url' => URL::action('VmanageCompaniesController@postStore'))) }}
	<div class="row marg-btm">
		<div class="pull-right">
			<a href="{{ URL::action('VmanageCompaniesController@getIndex') }}" class="btn btn-default">Anuluj</a>
		</div>
	</div>
	...
	<div class="row">
        <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-lg-3 marg-btm">
                    <div class="form-group">
                        {{ Form::text('nip', '', array('id'=>'nip', 'class' => 'form-control tips required', 'required' , 'placeholder' => 'NIP', 'title' => 'NIP'))  }}
                    </div>
                </div>
                <div class="col-md-4 col-lg-3 marg-btm">
                    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-4 col-lg-3  marg-btm">
                    <div class="form-group">
                        {{ Form::text('post', '', array('id'=>'post', 'class' => 'form-control tips', 'placeholder' => 'kod pocztowy', 'title' => 'kod pocztowy'))  }}
                    </div>
                </div>
                <div class="col-md-4 col-lg-3 marg-btm">
                    <div class="form-group">
                        {{ Form::text('city', '', array('id'=>'city', 'class' => 'form-control tips ', 'placeholder' => 'miasto', 'title' => 'miasto'))  }}
                    </div>
                </div>
                <div class="col-md-4 col-lg-3 marg-btm">
                    <div class="form-group">
                        {{ Form::text('street', '', array('id'=>'street', 'class' => 'form-control tips ', 'placeholder' => 'ulica', 'title' => 'ulica'))  }}
                    </div>
                </div>
                <div class="col-md-4 col-lg-3 marg-btm">
                    <div class="form-group">
                ...
                <div class="col-md-4 col-lg-3 marg-btm">
                    <div class="form-group">
                        {{ Form::text('mail', '', array('id'=>'mail', 'class' => 'form-control tips email', 'placeholder' => 'adres email', 'title' => 'adres email'))  }}
                    </div>
                </div>
            </div>
        </div>
