        ...
        <table style="width: 100%;" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td style="width: 50%; text-align: right;">
                    ...
                    <br/>
                    <strong>Multifinance Expert Sp. z o.o.</strong>
                </td>
            </tr>
        </table>
    </div>
    <div style="display:block; margin-top: 20px;">
        @if($policy->generalContract())
    ...
    <div style="display:block; margin-top: 20px;">
        <table style="width: 100%;" cellspacing="0" cellpadding="0">
            ...
            <tr class="tr-grey">
                ...
                <td style="width: 25%;" class="strong" colspan="3">
                    {{ $policy->leasingAgreement->client->name }} <br/>
                    {{ $policy->leasingAgreement->client->registry_street }} <br>
                    {{ $policy->leasingAgreement->client->registry_post }} {{ $policy->leasingAgreement->client->registry_city }}
                </td>
            </tr>
            <tr>
                <td colspan="4" style="padding: 5px;"></td>
