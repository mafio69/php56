...
<div class="modal-body">
    <div class="panel-body">
        <form action="{{ URL::to('insurances/create/store-client') }}" method="post"  id="dialog-form">
            <fieldset>
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-primary" id="addClient" data-loading-text="Trwa tworzenie leasingobiorcy...">
        Dodaj
    </button>
</div>
<script type="text/javascript">
    $('#NIP_to_check').focusout(function () {
        if ($(this).val().length > 0) {
            $.ajax({
                url: "{{ URL::to('insurances/create/check-client-nip') }}",
                data: {
