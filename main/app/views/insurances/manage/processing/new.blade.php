...
@section('main')
    <div class="row">
        ...
        {{ Form::open(array('url' => URL::to('insurances/store/add-new'), 'id' => 'page-form' )) }}
        ...
        <div class="col-sm-12 " id="insurances-container" style="display: none;">
            <div class="row">
                <div class="form-group col-sm-12 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
                    <label for="owner_id">Wybierz spółkę, do której przypisać umowy:</label>
                    ...
                    <div class="panel panel-danger">
                        <div class="panel-heading pointer" role="tab" id="headingOne">
                            <h4 class="panel-title collapse-header" data-toggle="collapse" data-target="#collapseMismatchedObjects" aria-expanded="false" aria-controls="collapseOne">
                                Przedmioty leasingu, które nie zostały dopasowane do umowy <span class="badge counted-agreements">0</span>
                                <i class="fa fa-arrows-v pull-right"></i>
                            </h4>
                        </div>
...
@section('headerJs')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $.ajax({
                type: "POST",
                url: "{{ URL::to('insurances/upload/parse', [$filename, 'new'])  }}",
                ...
                success: function( data ) {
                    ...
                    if(data.status == 'error'){
                        ...
                        if(isset(data.parsedData.new)){
                            ...
                            $('#new-insurances-container span.counted-agreements').html(data.parsedData.new.length);
                        ...
                        if(isset(data.parsedData.exist)){
                            ...
                            $('#exist-insurances-container span.counted-agreements').html(data.parsedData.exist.length);
                        ...
                        if(isset(data.parsedData.mismatched)){
                            ...
                            $('#mismatched-objects-container span.counted-agreements').html(data.parsedData.mismatched.length);
