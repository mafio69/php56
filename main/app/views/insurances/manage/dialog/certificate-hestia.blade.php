...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">Generowanie dokumentu certyfikatur Hestii</h4>
</div>
<div class="modal-body" style="overflow:hidden;">
    <form action="{{ URL::to('insurances/documents/generate-hestia-certificate', [$policy->id]) }}" method="post"  id="dialog-form">
        {{Form::token()}}
