        ...
        <div class="col-lg-10 col-lg-offset-1 ">
            <div class="panel panel-primary ">
                <div class="panel-body">
                    {{ Form::open(array('url' => URL::to('insurances/manage-actions/store-after-refund-yacht', [$leasingAgreement->id]), 'class' => 'page-form form-horizontal', 'id' => 'page-form' )) }}
                    <div class="row">
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input value="{{ $leasingAgreement->installments }}" class="form-control" name="months" id="months" placeholder="długość trwania polisy" >
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input value="" class="form-control date required" name="date_to" id="date_to"   placeholder="polisa do" readonly>
                        ...
                        <div class="col-sm-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    {{ Form::text('commission_value', '', array('class' => 'form-control currency_input number', 'placeholder' => 'wysokość prowizji') ) }}
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label">Data prowizji</label>
                                <div class="col-sm-8">
                                    {{ Form::text('commission_date', '', array('class' => 'form-control date dynamic_datepicker', 'placeholder' => 'data prowizji') ) }}
                                </div>
                            </div>
