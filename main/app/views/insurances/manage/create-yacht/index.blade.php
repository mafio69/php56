...
@section('header')
    ...
    Wprowadzanie nowej umowy jachtu
        ...
        <div class="col-lg-10 col-lg-offset-1 ">
            <div class="panel panel-primary ">
                <div class="panel-body">
                    {{ Form::open(array('url' => URL::to('insurances/create-yacht/store'), 'class' => 'page-form form-horizontal', 'id' => 'page-form' )) }}
                    <div class="row marg-btm">
                        @include('insurances.manage.create.partials.client')
                        @include('insurances.manage.create-yacht.partials.agreement-info')
                        @include('insurances.manage.create-yacht.partials.yachts')
                    </div>
