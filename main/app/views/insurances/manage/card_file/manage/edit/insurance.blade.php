...
@section('main')
    <div class="col-lg-10 col-lg-offset-1 ">
        <div class="alert alert-warning" role="alert">
                <i class="fa fa-exclamation-triangle"></i> wartości z przed edycji podawane są w szarych polach.
        </div>
    </div>
                ...
                <div class="panel-body">
                        ...
                        <div class="col-sm-12 col-md-6">
                            ...
                            @else
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input value="{{ $insurance->months }}" class="form-control number" name="months" id="months" readonly>
                                    </div>
                                </div>
                            @endif
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input value="{{ $insurance->date_to }}" class="form-control  date required" name="date_to" id="date_to"    placeholder="polisa do" >
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 col-md-6">
                            ...
                            <div class="form-group foreign-policy">
                                ...
                                <div class="col-sm-8">
                                    <div class="checkbox">
                                        <label>
                                            <input name="if_rounding" id="if_rounding" value="1" type="checkbox" @if($insurance->if_rounding == 1) checked @endif> Zaokrąglaj wartości stawek i składek
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group foreign-policy">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input value="{{ $insurance->rate }}" class="form-control number currency_input required" name="rate"  placeholder="stawka leasingodawcy" id="rate" require>
                                        <span class="input-group-addon tips" title="wartość przed edycją">{{ $insurance->rate }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input value="{{ $insurance->rate_lessor }}" class="form-control  foreign-policy-input number currency_input required" name="rate_lessor"  placeholder="stawka leasingobiorcy" id="rate_lessor" require>
                                        <span class="input-group-addon tips" title="wartość przed edycją">{{ $insurance->rate_lessor }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group"  id="contribution_lessor-container">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-addon tips" title="wartość przed edycją">{{ $insurance->contribution_lessor }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group" id="last_year_lessor_contribution_container" @if($insurance->last_year_lessor_contribution == '0.00' || is_null($insurance->last_year_lessor_contribution))style="display: none;" @endif>
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-addon tips" title="wartość przed edycją">{{ $insurance->last_year_lessor_contribution }}</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row marg-top">
                        <div class="text-center col-md-8 col-md-offset-2" >
                            {{ Form::submit('Zapisz zmiany',  array('class' => 'form_submit btn btn-primary btn-block', 'id' => 'form_submit', 'data-loading-text' => 'Trwa wprowadzanie zmian...'))  }}
                        </div>
                    </div>
                    {{ Form::close() }}
                </div>
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.status == 'error') {
                                ...
                                $('#group_rate option[value=' + 0 + ']').attr('selected', 'selected');
                ...
                $.ajax({
                    ...
                    success: function( data ) {
                        if(isset(data.error)){
                            ...
                            $('#rate').val('').parent().parent().parent().addClass('has-error has-feedback tips').attr('title', data.error);
                            $('#contribution_lessor').val('').parent().parent().parent().addClass('has-error has-feedback tips').attr('title', data.error);
                            $('#rate_lessor').val('').parent().parent().parent().addClass('has-error has-feedback tips').attr('title', data.error);
                            ...
                            $('#contribution').val(data.contribution).parent().parent().parent().removeClass('has-error has-feedback tips').removeAttr('title').tooltip('hide');
                            $('#rate').val(data.rate).parent().parent().parent().removeClass('has-error has-feedback tips').removeAttr('title').tooltip('hide');
                            $('#contribution_lessor').val(data.contribution_lessor).parent().parent().parent().removeClass('has-error has-feedback tips').removeAttr('title').tooltip('hide');
                            $('#rate_lessor').val(data.rate_lessor).parent().parent().parent().removeClass('has-error has-feedback tips').removeAttr('title').tooltip('hide');
