    ...
    <form action="{{ URL::to('insurances/info-dialog/update-object', [$object->id]) }}" method="post"  id="dialog-form">
        <fieldset>
            ...
            <div class="form-group">
                ...
                {{ Form::text('fabric_number', $object->fabric_number, array('class' => 'form-control ', 'placeholder' => 'numer fabryczny jachtu')) }}
            </div>
            <div class="form-group">
                <label>Nr rejestracyjny:</label>
                {{ Form::text('registration_number', $object->registration_number, array('class' => 'form-control ', 'placeholder' => 'numer rejestracyjny jachtu')) }}
            </div>
        </fieldset>
        {{Form::token()}}
    </form>
