...
?>
 <div class="modal-header">
  ...
  <div class="modal-body" style="overflow:hidden;">
  	<form action="{{ URL::to('insurances/info-dialog/set-upload-document') }}" method="post"  id="dialog-set-doc-form">
        ...
        <div class="form-group">
        	<div class="row">
          		<div class="col-sm-12 marg-btm">
                    ...
                    <div class="row">
                        @foreach(Config::get('definition.insurancesFileCategory') as $k =>$v)
                            <div class="col-md-4 ">
                                <div class="radio">
                                    <label>
