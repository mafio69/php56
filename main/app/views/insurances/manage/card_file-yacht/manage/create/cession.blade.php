                    ...
                    <div class="row">
                        <div class="col-sm-12" id="cession_container">
                            <h4 class="page-header marg-top-min overflow">Wyszukaj leasingobiorcę do cesji
                                <p class="pull-right btn btn-sm btn-primary modal-open" target="{{ URL::route('insurances.get', ['infoDialog', 'createClient']) }}" data-toggle="modal" data-target="#modal"><i class="fa fa-plus"></i> dodaj nowego leasingobiorcę</p>
                            </h4>
