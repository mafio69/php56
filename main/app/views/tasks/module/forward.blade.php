...
@section('header')
    Przekazywanie email zadania
@stop

@section('main')
    <form action="{{ URL::to('tasks/forward') }}" method="post"  enctype="multipart/form-data" id="page-form">
        {{Form::token()}}
        ...
        <div class="row marg-btm">
            <div class="col-sm-4">
                <label>
                    Adresat (rodziel przecinkiem):
                </label>
                <input type="text" name="recipient" id="emails" class="form-control email required" required placeholder="Adresaci (rodziel przecinkiem)">
            </div>
            <div class="col-sm-4">
                <label>
                    Nadawca:
                </label>
                <input type="text" name="sender" class="form-control email required" value="{{ $sender }}" required>
            </div>
            <div class="col-sm-4">
                <label>Podpis</label>
        ...
        <div class="row marg-btm">
            <div class="col-sm-6">
                ...
                {{ Form::text('bcc_emails', null, ['class' => 'form-control', 'id' => 'bcc-emails']) }}
            </div>
        </div>
        <div class="row marg-btm">
            <div class="col-sm-12">
