...
@section('main')
    ...
    @include('dos.other_injuries.card_file.nav')
  <div class="tab-content">

    @include('dos.other_injuries.card_file.injury_data')

    @include('dos.other_injuries.card_file.documentation')

    @include('dos.other_injuries.card_file.photos')

    @include('dos.other_injuries.card_file.localization')
    @include('dos.other_injuries.card_file.invoices')
    @include('dos.other_injuries.card_file.communicator')
    @include('dos.other_injuries.card_file.history')

    @include('dos.other_injuries.card_file.gen_docs')

    @if(Config::get('webconfig.WEBCONFIG_SETTINGS_bramka_sms') == 1 )
        @include('dos.other_injuries.card_file.sms')
    @endif

    @if( $injury->step == '-9' || $injury->theft)
        @include('dos.other_injuries.card_file.theft')
    @endif
  ...
  @parent
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#modal-sm, #modal, #modal-lg').on('click', '#del-doc', function(){
            ...
            $('#modal, #modal-sm, #modal-lg').on('click', '#set-injury', function(){
                btn = $(this);
                ...
                init: function () {
                    this.on("complete", function (file) {
                        if (this.getUploadingFiles().length === 0 && this.getQueuedFiles().length === 0) {
                            hrf="<?php echo URL::route('dos.other.injuries.getDocumentSet');?>";
            ...
            $('#modal, #modal-lg').on('click', '#cancel_docs', function(){
                $.post(
                    ...
                    function( data ) {
                        if(data == '0'){
                          ...
                          $('#modal .modal-body, #modal-lg .modal-body').html( data);
                        }
                    },
                    'json'
                );
            ...
            $('#modal, #modal-lg').on('click', '#set_docs', function(){
            ...
            $('#modal, #modal-lg').on('keypress', function(e){
