                ...
                <tr>
                    <td>
                        ...
                        @if(Session::get('search.injury_type', '0') != 0)
                            ...
                            <?php $exist_filter = 1;?>
                        @endif
                        @if(Session::get('search.user_id', '0') != 0 || Session::get('search.leader_id', '0') != 0)
        ...
        @parent
            <div class="notification_nav l-menu-content tips " title="zadania przedawnione">
                <table>
                    <tr>
                        <td>
                            <form role="form" action="{{ URL::route('dos.other.injuries.search.expired') }}">
            ...
            <div class="notification_nav l-menu-content tips" title="zadania na dziś">
                <table>
                    <tr>
                        <td>
                            <form role="form" action="{{ URL::route('dos.other.injuries.search.today') }}">
                                <button type="submit"  class="btn btn-primary btn-xs
