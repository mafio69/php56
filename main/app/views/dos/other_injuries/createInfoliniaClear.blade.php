        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="row injury_bg ">
                    ...
                    <div class="col-md-2 marg-btm " >
                        <a class="btn btn-warning btn-sm" href="{{ URL::route('dos.other.injuries.create.infolinia') }}">Wprowadź w ISDL</a>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-6 editable marg-btm">
                        <div class="form-group">
                            <label class="input-group  marg-btm" id="client_idea">
                                <select name="client_id" id="client_id" class="form-control required tips" title="klient" >
                                    <?php foreach($clients as $v){
                                        echo '<option value="'.$v->id.'">'.$v->name.'</option>';
                                    }?>
                                </select>
                                <span class="input-group-btn">
                                    <button target="{{{ URL::route('dos.other.injuries.newClient') }}}" class="btn btn-default modal-open tips" data-toggle="modal" data-target="#modal"  type="button" title="Dodaj nowego klienta"><span class="fa fa-plus"></span></button>
                                </span>
                                <span class="input-group-btn">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-4 col-lg-3  marg-btm">
                        <div class="form-group">
                            {{ Form::text('end_leasing', '', array('id'=>'end_leasing', 'class' => 'form-control upper tips',  'placeholder' => 'Data końca leasingu', 'title' => 'Data końca leasingu'))  }}
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-3  marg-btm">
                        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-4 col-lg-3  marg-btm">
                        <div class="form-group">
                            {{ Form::text('expire', '', array('id'=>'expire', 'class' => 'form-control upper tips', 'placeholder' => 'Data ważności polisy', 'title' => 'Data ważności polisy z serwera IL'))  }}
                        </div>
                    </div>
                </div>
            </div>
            ...
            $('#modal').on('click', '#addClient', function(){
                ...
                if($('#create-form').valid() ){
                    $.post(
                        ...
                        function( data ) {
                            if(data == '0'){
                                hrf="<?php echo URL::route('dos.other.injuries.listClients');?>";
