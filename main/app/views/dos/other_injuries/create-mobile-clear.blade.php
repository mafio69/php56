...
@section('header')
    ...
    Dodawanie nowego zlecenia mobilnego
...
@section('main')
    <form action="{{ URL::route('dos.other.injuries.post' ) }}" method="post" role="form">
        ...
        @endif
        {{ Form::hidden('injury_id', $injury->id) }}
        <div class="row">
            <div class="form-group">
                ...
                <div class="row injury_bg ">
                    ...
                    <div class="col-md-2 marg-btm " >
                        <a class="btn btn-warning btn-sm" href="{{ URL::route('dos.other.injuries.create-mobile', [$injury->id]) }}">Wprowadź w ISDL</a>
                    </div>
            ...
            <div class="form-group">
                ...
                <div id="object_container">
                    <div class="row">
                        <div class="col-md-4 col-lg-3 marg-btm">
                            <div class="form-group">
                                {{ Form::text('description', $injury->rdl, array('id'=>'description', 'class' => 'form-control upper tips', 'placeholder' => 'Opis przedmiotu', 'title' => 'Opis przedmiotu'))  }}
                            </div>
                        </div>
                        <div class="col-md-4 col-lg-3 marg-btm">
                            <div class="form-group">
                                {{ Form::text('factoryNbr', $injury->ipl, array('id'=>'factoryNbr', 'class' => 'form-control upper tips',  'placeholder' => 'Numer fabryczny', 'title' => 'Numer fabryczny'))  }}
                            </div>
                        </div>
                        <div class="col-md-4 col-lg-3 marg-btm">
            ...
            <div class="form-group">
                ...
                <div class="row injury_bg">
                    ...
                    <div class="col-md-4 col-lg-3 marg-btm tips"  title ='Telefon zgłaszającego'>
                        {{ Form::text('notifier_phone', $injury->notifier_phone, array('class' => 'form-control bold upper', 'placeholder' => 'telefon'))  }}
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="row injury_bg">
                    ...
                    <div class="col-md-4 col-lg-4 marg-btm">
                        {{ Form::text('event_city',  $injury->event_city, array('class' => 'form-control bold  upper', 'id' => 'city', 'placeholder' => 'miasto'))  }}
                    </div>
                    <div class="col-md-4 col-lg-4 marg-btm">
        ...
        <div class="form-group">
            ...
            <div class="row injury_bg marg-btm">
                <div class="col-md-12 marg-btm">
                    ...
                    {{ Form::textarea('info', $description, array('class' => 'form-control  bold', 'placeholder' => 'Informacja wewnętrzna'))  }}
                </div>
            </div>
        </div>
...
@section('headerJs')
    ...
    <script type="text/javascript" >
        ...
        $(document).ready(function(){
            ...
            $('#date_event').datepicker({ showOtherMonths: true, selectOtherMonths: true,  showOtherMonths: true, selectOtherMonths: true,  changeMonth: true,changeYear: true,maxDate: "+0D",dateFormat: "yy-mm-dd" });
            ...
            $('#end_leasing').datepicker({ showOtherMonths: true, selectOtherMonths: true,  showOtherMonths: true, selectOtherMonths: true,  changeMonth: true,changeYear: true, dateFormat: "yy-mm-dd" });;
            $('#expire').datepicker({ showOtherMonths: true, selectOtherMonths: true,  showOtherMonths: true, selectOtherMonths: true,  changeMonth: true,changeYear: true, dateFormat: "yy-mm-dd" });;
