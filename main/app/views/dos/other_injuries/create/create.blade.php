...
@section('main')
	<form action="{{ url('dos/other/injuries/make/store' ) }}" method="post" role="form" id="create-form">
		...
		<div class="row">
			<div class="form-group">
				...
				<div class="row injury_bg ">
					<div class="col-md-4 col-lg-3 marg-btm tips" title = 'Nr umowy leasingowej'>
						<p class="form-control input-sm" disabled="">{{ $contract ? $contract->contract_number : $object->nr_contract }} </p>
					</div>
				</div>
			</div>
			<div class="form-group">
					...
					<div class="row">
						<div class="col-md-4 col-lg-3 marg-btm">
							<div class="form-group">
								...
								{{ Form::text('description', $object->description, array('id'=>'description', 'class' => 'form-control upper tips', 'placeholder' => 'Opis przedmiotu', 'title' => 'Opis przedmiotu'))  }}
							</div>
						</div>
						<div class="col-md-4 col-lg-3 marg-btm">
							<div class="form-group">
						...
						<div class="col-md-4 col-lg-3 marg-btm">
                            <span class="input-group tips" title="Kategoria">
                                <select name="assetType_id" id="assetType_id" class="form-control required" >
                                    ...
                                    @foreach($assetTypes as $k => $v)
										<option value="{{ $v->id }}" @if($objectType && $objectType->id == $v->id  ) selected @endif>{{ $v->name }}</option>
									@endforeach
                                </select>
							...
							@if(! $objectType)
								<span class="small">{{ $object->object_type }}</span>
							@endif
						</div>
						<div class="col-md-4 col-lg-3 marg-btm">
							<div class="form-group">
								{{ Form::text('year_production', $object->year_production, array('id'=>'year_production', 'class' => 'form-control upper tips',  'placeholder' => 'Rok produkcji', 'title' => 'Rok produkcji'))  }}
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-6 col-lg-6 editable marg-btm">
						<div class="input-group">
							<p class="form-control tips" disabled="" title="Właściel" > {{ $contract ? $contract->owner->contractor_name : $object->owner->name }}</p>
							<span class="input-group-btn">
								@if($contract)
								...
								@else
									<button class="btn btn-default modal-open" type="button" off-disable target="{{ URL::to('injuries/make/show-dls-owner', array($object->owner->id)) }}" data-toggle="modal" data-target="#modal">
										<i class="fa fa-search"></i>
									</button>
								@endif
							</span>
					...
					<div class="col-md-6 col-lg-6 editable marg-btm">
						<div class="input-group">
							<p class="form-control tips" title="Klient" disabled=""> {{ $contract ? $contract->object_user->contractor_name : ($object->client ? $object->client->name : '') }}</p>
							<span class="input-group-btn">
								@if($contract)
								...
								@elseif($object->client)
									<button class="btn btn-default modal-open" type="button" off-disable target="{{ URL::to('injuries/make/show-dls-object-user', array($object->client->id)) }}" data-toggle="modal" data-target="#modal">
										<i class="fa fa-search"></i>
									</button>
								@endif
							</span>
			...
			<div class="form-group">
				...
				<div class="row">
					<div class="col-md-4 col-lg-3  marg-btm">
						<div class="form-group">
							{{ Form::text('end_leasing', $contract ? $contract->contract_planned_ending_date : $object->end_leasing, array('id'=>'end_leasing', 'class' => 'form-control upper tips',  'placeholder' => 'Data końca leasingu', 'title' => 'Data końca leasingu', 'autocomplete' => 'off'))  }}
						</div>
					</div>
					<div class="col-md-4 col-lg-3  marg-btm">
						<div class="form-group">
							{{ Form::text('contract_status', $contract ? $contract->contract_status : $object->contract_status, array('id'=>'contract_status', 'class' => 'form-control upper tips', 'placeholder' => 'Status umowy', 'title' => 'Status umowy'))  }}
						</div>
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="row">
					<div class="col-md-4 col-lg-3  marg-btm">
						<div class="form-group">
							{{ Form::text('expire', $policy ? $policy->policy_date_to : (!$contract ? $object->expire : ''), array('id'=>'expire', 'class' => 'form-control upper tips', 'placeholder' => 'Data ważności polisy', 'title' => 'Data ważności polisy', 'autocomplete' => 'off'))  }}
						</div>
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="row injury_bg">
					<div class="col-md-4 col-lg-3 marg-btm tips" title ='Imię zgłaszającego'>
						{{ Form::text('notifier_name', '', array('class' => 'form-control bold  required upper', 'placeholder' => 'imię', 'autocomplete' => 'off'))  }}
					</div>
					<div class="col-md-4 col-lg-3 marg-btm tips" title = 'Nazwisko zgłaszającego'>
						{{ Form::text('notifier_surname', '', array('class' => 'form-control bold required upper', 'placeholder' => 'nazwisko', 'autocomplete' => 'off'))  }}
					</div>
					<div class="col-md-4 col-lg-3 marg-btm tips"  title ='Telefon zgłaszającego'>
						{{ Form::text('notifier_phone', '', array('class' => 'form-control bold upper', 'placeholder' => 'telefon', 'autocomplete' => 'off'))  }}
					</div>
					<div class="col-md-4 col-lg-3 marg-btm tips" title = 'Email zgłaszającego'>
						{{ Form::text('notifier_email', '', array('class' => 'form-control bold email', 'placeholder' => 'email', 'autocomplete' => 'off'))  }}
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="row injury_bg">
					<div class="col-md-4 col-lg-4 marg-btm">
						...
						{{ Form::text('date_event', '', array('class' => 'form-control bold required', 'id'=>'date_event', 'placeholder' => 'data zdarzenia', 'autocomplete' => 'off'))  }}
					</div>
				...
				<div class="row injury_bg">
					...
					<div class="col-md-4 col-lg-4 marg-btm">
						{{ Form::text('event_city', '', array('class' => 'form-control bold  upper', 'id' => 'city', 'placeholder' => 'miasto', 'autocomplete' => 'off'))  }}
					</div>
					<div class="col-md-4 col-lg-4 marg-btm">
						{{ Form::text('event_street', '', array('class' => 'form-control bold  upper', 'id' => 'street', 'placeholder' => 'ulica', 'autocomplete' => 'off'))  }}
					</div>
					<div class="col-md-12 marg-btm">
						<div class="checkbox">
							<label>
		...
		{{Form::hidden('object_id', $object->id, array('id' => 'object_id'))}}
		...
		{{ Form::hidden('policy_insurance_company_id', $insurance_company_id) }}

		{{ Form::hidden('owner_id', isset($object->owner_id) ? $object->owner_id : null) }}
		{{ Form::hidden('client_id', isset($object->client_id) ? $object->client_id : null ) }}
