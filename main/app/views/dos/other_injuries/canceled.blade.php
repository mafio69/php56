		...
		<table class="table  table-hover  table-condensed" id="users-table">
			...
			<?php
				...
				>
                    ...
                    <td>{{ $injury->object->assetType ? checkObjectIfNotNull($injury->object->assetType, 'name') : '' }}</td>
                    <Td>
					...
					@include('dos.other_injuries.actions.canceled_options')
				</tr>
				<?php }
			 ?>
