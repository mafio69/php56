    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 item-m">
            ...
            <div class="panel panel-default small">
                 <div class="panel-heading">
                     @if($object->syjon_contract_id)
                         <a target="_blank" href="{{ Config::get('webconfig.SYJON_URL').'/contract/card-file-external/info/'.$object->syjon_contract_id }}" class="btn btn-xs btn-info" off-disable>
                    ...
                    <tr>
                        <Td colspan="2">
                            ...
                            @if(Auth::user()->can('zlecenia#zarzadzaj'))
                                <i class="fa fa-pencil-square-o pull-right tips modal-open" target="{{ URL::route('dos.other.injuries.getEditInjuryClientContact', array($injury->id)) }}" data-toggle="modal" data-target="#modal" title="edytuj" style="font-size: 17px;cursor: pointer;"></i>
                            @endif
                        </td>
                    </tr>
                    <tr>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 item-m">
            ...
            <div class="panel panel-default small">
                <div class="panel-heading ">Dane szkody:
                    @if(Auth::user()->can('zlecenia#zarzadzaj'))
                      <i class="fa fa-pencil-square-o pull-right tips modal-open-lg" target="{{ URL::route('dos.other.injuries.getEditInjury', array($injury->id)) }}" data-toggle="modal" data-target="#modal-lg" title="edytuj"></i>
                    @endif
                </div>
                <table class="table">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if($injury->receive_id == 1)
                                <span class="tips" title="{{ $injury->receiver_name }}, {{ $injury->receiver_address }}">
            ...
            <div class="panel panel-default small">
                 <div class="panel-heading ">Dane polisy leasingowej
                     @if(Auth::user()->can('zlecenia#zarzadzaj'))
                       <i class="fa fa-pencil-square-o pull-right tips modal-open" target="{{ URL::route('dos.other.injuries.getEditInjuryInsurance', array($injury->id)) }}" data-toggle="modal" data-target="#modal" title="edytuj"></i>
                     @endif
                 </div>
                 <table class="table">
                    <tr>
        ...
        <div class="col-sm-6 col-md-4  col-lg-3 item-m">
            ...
            <div class="panel panel-default small">
                <div class="panel-heading ">
                    <a target="_blank"
                       href="{{ Config::get('webconfig.SYJON_URL').'/object/card/info/'.$object->syjon_vehicle_id }}"
                       class="btn btn-xs btn-info" off-disable
                       @if(!$object->syjon_vehicle_id )
                        disabled readonly="readonly"
                       @endif
                    >
                        <i class="fa fa-search" style="font-size: 12px;"></i>
                    </a>
                    <span>Dane przedmiotu szkody</span>
                    @if(Auth::user()->can('zlecenia#zarzadzaj'))
                        <i class="fa fa-pencil-square-o pull-right tips modal-open" target="{{ URL::route('dos.other.injuries.get', array('getEditObject', $injury->id)) }}" data-toggle="modal" data-target="#modal" title="edytuj"></i>
                    @endif
                </div>
                <table class="table">
                    <tr>
            ...
            <div class="panel panel-default small">
                <div class="panel-heading overflow">
                    ...
                    @if(Auth::user()->can('zlecenia#zarzadzaj'))
                        <i class="fa fa-pencil-square-o pull-right tips modal-open" target="{{ URL::route('dos.other.injuries.get', array('getEditNotifier', $injury->id)) }}" data-toggle="modal" data-target="#modal" title="edytuj"></i>
                    @endif
                </div>
                <table class="table">
                    <tr>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 item-m">
            ...
            <div class="panel panel-default small">
                <div class="panel-heading ">Dane sprawcy
                    @if($injury->offender_id != 0 && Auth::user()->can('zlecenia#zarzadzaj'))
                        <i class="fa fa-pencil-square-o pull-right tips modal-open" target="{{ URL::route('dos.other.injuries.getEditInjuryOffender', array($injury->id)) }}" data-toggle="modal" data-target="#modal" title="edytuj"></i>
                    @endif
                </div>
        ...
        <div class="col-sm-6  item-m">
            <div class="panel panel-default small">
               <div class="panel-heading ">Informacja wewnętrzna:
                   @if(Auth::user()->can('zlecenia#zarzadzaj'))
                        <i class="fa fa-pencil-square-o pull-right tips modal-open" target="{{ URL::route('dos.other.injuries.getEditInjuryInfo', array($injury->id)) }}" data-toggle="modal" data-target="#modal" title="edytuj"></i>
                   @endif
               </div>
               <table class="table">
