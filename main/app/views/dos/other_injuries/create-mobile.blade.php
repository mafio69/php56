...
<form action="{{ URL::route('dos.other.injuries.post' ) }}" method="post" role="form">
	<div class="row marg-btm">
		<div class="pull-right">
			<a href="{{{ URL::route('dos.other.injuries.new' ) }}}" class="btn btn-default">Anuluj</a>
		</div>
	</div>
	@if($errors->any())
	<div class="row">
	...
	<div class="row">
		<div class="form-group">
			...
			<div class="row injury_bg ">
                ...
                <div class="col-md-2 marg-btm " >
                    <a class="btn btn-warning btn-sm" href="{{ URL::route('dos.other.injuries.create-mobile.clear', [$injury->id]) }}">Wprowadź poza ISDL</a>
                </div>
		...
		<div class="form-group">
			...
			<div class="row">
				<div class="col-md-4 col-lg-3  marg-btm">
				    <div class="form-group">
                        {{ Form::text('end_leasing', '', array('id'=>'end_leasing', 'class' => 'form-control upper tips', 'readonly' => 'readonly', 'placeholder' => 'Data końca leasingu', 'title' => 'Data końca leasingu', 'autocomplete' => 'off'))  }}
                    </div>
				</div>
				<div class="col-md-4 col-lg-3  marg-btm">
				    <div class="form-group">
				...
				if($(this).val().length > 0 && $(this).val().length < 11 && focus == 0){
		    		...
		    		$.ajax({
				        ...
				        success: function( data ) {
                            ...
                            var object;
                            if(count_found == 0) {
								$('#modal .modal-body').html('Brak wyników.');
								$('#modal .modal-footer').html('<button type="button" class="btn btn-default" data-dismiss="modal">Zamknij</button>');
