...
<div id="body">
    <div class="page"  id="content">
        ...
        <p style="margin-top: 50px; font-size:9pt; line-height: 1.2;">
            Idea Getin Leasing S.A. z siedzibą we Wrocławiu przy ul. Strzegomskiej 42b będąca właścicielem w/w przedmiotu zwraca się z prośbą o przekazanie wypłaty odszkodowania na konto:
            <br>
            <strong>
        ...
        <p style="margin-top: 50px; font-size:9pt; ">
            <span style="border-bottom: 1px solid black;">
                Upoważnienie dotyczy kradzieży.
            </span>
        </p>
