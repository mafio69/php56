...
<div id="body">
    <div class="page"  id="content">
        ...
        <p style="margin-top: 50px; font-size:9pt; line-height: 1.2;">
            Idea Getin Leasing S.A. z siedzibą we Wrocławiu przy ul. Strzegomskiej 42b będąca właścicielem w/w przedmiotu zwraca się z prośbą o przekazanie wypłaty odszkodowania za szkodę całkowitą na konto:
            <br>
            <strong>
            ...
            <br>
            <strong>
                89 1560 0013 2077 0562 5000 0006
            </strong>
            <br>
            z zaznaczeniem numeru sprawy {{ $injury->object->nr_contract }}
        </p>

        <p style="margin-top: 50px; font-size:9pt; ">
            <span style="border-bottom: 1px solid black;">
                Upoważnienie dotyczy szkody całkowitej.
            </span>
        </p>

        <p style="margin-top: 50px; font-weight: bold; line-height: 1.5; font-size:9pt;">
