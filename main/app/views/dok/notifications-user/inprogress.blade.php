		...
		>
			...
			<td>
				<div class="btn-group " style="min-width:130px;" >
					<button target="{{ URL::route('dok.notifications.getComplete', array($notifi->id)) }}" type="button" class="btn btn-primary btn-sm modal-open-sm" data-toggle="modal" data-target="#modal-sm" >zakończ zgłoszenie</button>
					<button type="button" class="btn btn-primary btn-sm dropdown-toggle" data-toggle="dropdown">
						<span class="caret"></span>
						<span class="sr-only">Toggle Dropdown</span>
					</button>
					<ul class="dropdown-menu" role="menu">
						<li><a href="#" target="{{ URL::route('dok.notifications.getComplete', array($notifi->id)) }}" class="modal-open-sm" data-toggle="modal" data-target="#modal-sm">zakończ zgłoszenie</a></li>
							<li class="divider"></li>
