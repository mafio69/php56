 <div class="modal-header">
  ...
  <div class="modal-body" style="overflow:hidden;">
  	<form action="{{ URL::route('dok.notifications.chat.postDeadline', array($id)) }}" method="post"  id="dialog-injury-form">
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      $('#deadline').datepicker({ showOtherMonths: true, selectOtherMonths: true, showOtherMonths: true});
