@if(Auth::user() && Auth::user()->signature)
    <img src="{{ url('templates-src/'.Auth::user()->signature) }}" alt="Podpis" style="height: 73px;"/>
@endif
<?php /*
...
@elseif(Auth::user()->login == 'msroka')
    <img src="templates-src/magdalena_sroka.png" alt="Podpis" style="height: 130px;"/>
@elseif(Auth::user()->login == 'magrze')
    <img src="templates-src/marta_grzeszczak.png" alt="Podpis" style="height: 130px;"/>
@elseif(Auth::user()->login == 'aszcza')
    <img src="templates-src/anna_szczawinska.png" alt="Podpis" style="height: 80px;"/>
