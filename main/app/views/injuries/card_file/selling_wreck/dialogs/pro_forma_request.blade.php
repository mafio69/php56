 <div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">Wysyłanie prośby o fakturę pro forma</h4>
  </div>
  <div class="modal-body" style="overflow:hidden;">
  	<form action="{{ URL::route('injuries.info.postProFormaRequest', array($wreck->id)) }}" method="post"  id="dialog-injury-form">
       {{Form::token()}}
