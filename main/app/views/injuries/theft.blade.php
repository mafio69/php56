	...
	<div  id="injuries-container">
		...
		<table class="table  table-hover  table-condensed" id="users-table">
			...
			<?php
				...
				>
					<td>{{$lp++}}.</td>
					<Td>@include('injuries.includes.theft_statuses')</td>
					<td>@include('injuries.theft_partials.alerts')</td>
					<td>
						@if($injury->status)
                    ...
                    @include('injuries.includes.theft_options')
				</tr>
				<?php }
			 ?>
