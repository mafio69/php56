  ...
  <div class="modal-body" style="overflow:hidden; padding-bottom:0px; ">
  	<form action="{{ URL::route('injuries-assignBranch', array($injury->id)) }}" method="post"  id="dialog-form">
  		<input type="hidden" id="lat" value="{{ $injury->lat }}"/>
        <input type="hidden" id="lng" value="{{ $injury->lng }}"/>
        <input type="hidden" id="lat_point" value="{{ $injury->lat }}"/>
        <input type="hidden" id="lng_point" value="{{ $injury->lng }}"/>
        ...
        <div class="row">
			...
			<div class="col-sm-6">
				<div class="checkbox">
				  <label>
					<input type="checkbox" id="onBrand">
					Uwzględnij markę samochodu
				  </label>
				</div>
			</div>
	  	...
	  	<div class="row">
	  		<div class="col-sm-12" style="padding: 0px 95px 0px 40px;">
	  			<div id="select-branch">
		  			<div class="row marg-btm"><h6>Zasięg poszukiwań [km]:</h6></div>
		  			<div class="row marg-btm">
		  				<input value="30" type="text" id="amount" style="border: 0; font-weight: bold; background-color:transparent; float:left; margin-top: -7px; width:40px;" />
		  				<div id="slider" style="margin-left:55px; width:100%;"></div>
		  			</div>
		  		</div>
		  	</div>
		</div>
		<div class="row">
			<div class="col-sm-12 marg-btm">
				<div class="checkbox">
					<label>
						<input type="checkbox" id="locate_on_map"> Zlokalizuj na mapie
					</label>
				</div>
			</div>
			<div class="col-sm-12 marg-btm">
  ...
  <div class="modal-footer">
    ...
    <button type="button" class="btn btn-primary" id="set">Przypisz serwis</button>
  </div>
