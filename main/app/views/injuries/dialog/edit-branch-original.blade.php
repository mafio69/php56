  <div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">Edycja oryginalnie przypisanego serwisu</h4>
  </div>
  <div class="modal-body" style="overflow:hidden; padding-bottom:0px; ">
  	<form action="{{ URL::route('injuries-setBranchOriginal', array($injury->id)) }}" method="post"  id="assign-branch-form">
