...
<div class="modal-body" style="overflow:hidden;">
        <form action="{{ URL::route('injuries-storeCessionAmounts', array($injury_id)) }}" method="post" id="dialog-form">
            {{Form::token()}}
    <div class="form-group">
{{--        <div class="row">--}}
{{--            <div class="col-sm-12 marg-btm">--}}
{{--                <label>Kwota wypłaconego odszkodowania</label>--}}
{{--                {{ Form::text('paid_amount', '', array('class' => 'form-control required', 'autocomlete' => 'off', 'id' => 'amountInput')) }}--}}
{{--            </div>--}}
{{--        </div>--}}

{{--        <div class="row marg-btm">--}}
{{--            <div class="col-sm-12 marg-btm">--}}
{{--                {{ Form::select('net_gross', Config::get('definition.compensationsNetGross'), null, ['class' => 'form-control', 'id' => 'amountType']) }}--}}
{{--            </div>--}}
{{--        </div>--}}
...
{{--                {{ Form::text('fv_amount', '', array('class' => 'form-control required', 'autocomlete' => 'off', 'id' => 'fvAmountInput')) }}--}}
{{--            </div>--}}
{{--        </div>--}}
