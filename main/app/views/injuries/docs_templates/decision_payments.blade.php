...
<div class="body content body-margin-big">
    <div class="t-body t-body-size-16">
        ...
        <p class="block text-justify">Szanowni Państwo,<br /><br />
            {{ (isset($ideaA[1])) ? $ideaA[1] : '---' }} w załączeniu przesyła decyzję dotyczącą wypłaty odszkodowania otrzymaną z
            Towarzystwa Ubezpieczeniowego likwidującego ww. szkodę.</p>

        @if(false)
        <p class="block text-justify">Przypominamy, iż zgodnie z Art. 81 ust. 11 pkt 5 ustawy Prawo o ruchu drogowym z dnia 20 czerwca 1997 roku istnieje obowiązek wykonania dodatkowego badania technicznego pojazdu, w którym została dokonana naprawa wynikająca ze zdarzenia powodującego odpowiedzialność zakładu ubezpieczeń z tytułu zawartej umowy ubezpieczenia. Obowiązek wykonania badania dotyczy sytuacji, gdy naprawa wykonywana była w zakresie elementów układu nośnego, hamulcowego lub kierowniczego mających wpływ na bezpieczeństwo ruchu drogowego. Zgodnie z Art. 17 ustawy z dnia 22 maja 2003 roku o działalności ubezpieczeniowej istnieje obowiązek poinformowania Ubezpieczyciela o wykonaniu dodatkowego badania technicznego.</p>
        @endif
