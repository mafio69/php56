...
<div id="body">
    ...
    <div class="page"  id="content">
        ...
        <div style="margin-top: 50pt; font-size: 9pt; font-weight: bold;">
            ...
            <p>Pojazd {{ $vehicle->brand }} {{ $vehicle->model }}; nr rejestracyjny {{ $vehicle->registration }}</p>
        ...
        <div style ="margin-top:30pt; font-size:9pt; text-align:justify;text-justify:inter-word;  line-height: 10pt;">
            ...
            <p style="text-indent: 30px; margin-top: 20px;">
                W związku z w/w szkodą komunikacyjną zakwalifikowaną jako całkowita {{ checkIfEmpty('1', $ideaA) }} z siedzibą we {{ checkIfEmpty('13', $ideaA) }} przy {{ checkIfEmpty('2', $ideaA) }}, będąc właścicielem przedmiotowego pojazdu, zwraca się z prośbą o <strong>dostarczenie do naszej dyspozycji</strong> pozostałości przedmiotu leasingu zgodnie z § 24 pkt. 3 Ogólnych Warunków Umowy Leasingu. Wraz z pojazdem prosimy o dostarczenie wszystkich kompletów kluczyków oraz wszelkiej dokumentacji pojazdu.
            </p>
