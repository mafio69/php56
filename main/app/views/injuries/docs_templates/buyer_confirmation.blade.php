<?php //Potwierdzenie oferty odkupu wraka przez nabywcę aukcyjnego ?>
		...
		<div class="page"  id="content">
			<div style="font-size: 7pt;">
				...
				<table style="font-size:14pt; margin-top:10pt; font-weight:bold;" align="center">
					<tr>
						<td style="text-align:center;">Potwierdzenie oferty odkupu wraka przez nabywcę aukcyjnego</td>
					</tr>
				</table>
