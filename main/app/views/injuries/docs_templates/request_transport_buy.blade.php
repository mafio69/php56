    ...
    <div class="page"  id="content" style="margin-top: 30px;">
        ...
        <div style ="margin-top:20px; font-size:8pt; text-align:justify;text-justify:inter-word;  line-height: 10pt;">
            ...
            <p style="text-indent:30px; margin-top: 20px;">
                W związku z w/w szkodą komunikacyjną zakwalifikowaną jako całkowita, działając w imieniu {{ checkIfEmpty('1', $ideaA) }} z siedzibą we {{ checkIfEmpty('13', $ideaA) }} przy {{ checkIfEmpty('2', $ideaA) }}, będącej właścicielem przedmiotowego pojazdu, w związku z rozwiązaniem wskazanej wyżej umowy w trybie § 25 ust. 1 Ogólnych Warunków Umowy Leasingu stanowiących integralną część przedmiotowej umowy (dalej: OWUL) oraz w związku z bezumownym pozostawaniem jej przedmiotu w Państwa posiadaniu składamy ofertę kupna, wskazanego pojazdu:
            </p>
