    ...
    <div class="page"  id="content">
        ...
        <div style ="margin-top:30pt; font-size:9pt; text-align:justify;text-justify:inter-word;  line-height: 10pt;">
            ...
            <p style="text-indent:30px; margin-top: 30pt;">
                {{ checkIfEmpty('1', $ideaA) }} w załączeniu przesyła decyzję otrzymaną z Towarzystwa Ubezpieczeniowego odmawiającego wypłaty odszkodowania z tytułu w/w szkody komunikacyjnej.
            </p>
