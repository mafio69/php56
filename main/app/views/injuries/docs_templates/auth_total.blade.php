    ...
    <div class="page"  id="content">
        ...
        <div style ="margin-top:40px; font-size:9pt; text-align:justify;text-justify:inter-word;  line-height: 10pt;">
            <p style="text-indent:30px;">
                W związku z w/w szkodą komunikacyjną zakwalifikowaną jako całkowita odszkodowanie powinno zostać przekazane na konto bankowe właściciela przedmiotu leasingu, czyli {{ checkIfEmpty('1', $ideaA) }} siedzibą we {{ checkIfEmpty('13', $ideaA) }} przy {{ checkIfEmpty('2', $ideaA) }}. <br/>
                Nr konta bankowego:
            ...
            <p style=" margin-top: 20px;">
                Udziały własne zostały wykupione, prosimy o ich nie potrącanie.
            </p>
