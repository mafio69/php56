...
<div class="body content body-margin-big">
    <div class="t-body t-body-size-14">
        ...
        <p class="block text-justify">Szanowni Państwo<br /><br />
            ...
            <b>
                W związku z otrzymaniem informacji o powstaniu w/w szkody komunikacyjnej, Informujemy Państwa o możliwości naprawy pojazdu w sieci wybranych serwisów. W takim przypadku zyskają Państwo: pierwszeństwo w przyjęciu pojazdu do naprawy, pomoc w zgłoszeniu szkody do ZU i skompletowaniu dokumentów, pokrycie kosztów podatku VAT przez Idea Getin Leasing *
            </b><br /><br />

            Jeżeli chcecie Państwo skorzystać z naszej oferty, prosimy o kontakt telefoniczny pod nr tel. <b>71 33 44 807</b>

            <br><br>

            W przypadku wyboru własnego serwisu prosimy o uzupełnienie wniosku o wydanie upoważnienia do wypłaty odszkodowania. Wypełniony dokument prosimy przesłać bezpośrednio na adres: <a href="mailto:szkody@ideagetin.pl">szkody@ideagetin.pl</a>. Wniosek do pobrania na stronie www.ideagetin.pl.
