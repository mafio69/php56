	...
	<div id="body">
		<div class="page"  id="content">
			...
			<div style ="margin-top:50pt; font-size:10pt; text-align:justify;text-justify:inter-word;">
				...
				<p >
	W związku ze zgłoszoną szkodą {{ (isset($ideaA[1])) ? $ideaA[1] : '---' }} z siedzibą we Wrocławiu przy {{ (isset($ideaA[2])) ? $ideaA[2] : '---' }} zwraca się z prośbą o przekazanie przyznanego odszkodowania z tytułu wymienionej szkody na rachunek Korzystającego:
				</p>
