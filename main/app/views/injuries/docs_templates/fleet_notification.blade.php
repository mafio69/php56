	...
	<div id="body">
		...
		<div class="page"  id="content">
			...
			<div style="font-size: 7pt;">
				...
				<table style="width: 100%; margin-top:20px; font-size: 9pt; font-weight:normal; border:none;">
					<tbody>
						<tr class="padding-top">
							<td style="width:25%;">Nr rejestracyjny<span style="float: right">:</span></td>
						...
						<tr >
							...
							<td style="width:25%;">{{ ($injury->vehicle_type == 'Vehicles') ? $vehicle->VIN : $vehicle->vin }}</td>
				...
				<table style="width: 100%; font-size: 9pt; font-weight:normal; border-left:none; border-right:none;">
					<tbody>
						<tr class="padding-top">
				...
				<table style="width: 100%; font-size: 9pt; font-weight:normal; border:none; ">
					<tbody>
						<tr class="padding-top" >
				...
				<table style="width: 100%; font-size: 9pt; font-weight:normal; margin-top:20px;">
					<tbody>
						<tr >
			...
			<div style ="margin-top:40px; font-size: 6pt;">
