...
<body>
<div id="body" style="padding: 1.0cm">
                ...
                <div>
                    <table style="float: left; width: 100%;">
                        ...
                        <tr>
                            ...
                            <td>
                                            <span>
                                        <input type="checkbox" {{$injury->in_service==1?' checked':''}}>TAK</span></td>
                            <td><span>
                                        <input type="checkbox" {{$injury->in_service==0?'':' checked'}}>NIE</span></td>
                        ...
                        <tr>
                            ...
                            <td>
                                            <span>
                                        <input type="checkbox" {{$injury->reported_ic?'checked':''}}>TAK</span></td>
                            <td><span>
                                        <input type="checkbox" {{!$injury->reported_ic?'checked':''}}>NIE</span></td>
                            <td></td>
                            <td></td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><span>
                                        <input type="checkbox" {{$injury->injuries_type()->first()->id==1?'
                                        checked':''}}> OC
                                    sprawcy</span></td>
                            <td><span>
                                        <input type="checkbox" {{ $injury->injuries_type()->first()->id==2?'
                                        checked':'' }}>AC użytkownika</span></td>
                            <td></td>
                            <td></td>
                            <td></td>
                        </tr>
                        <tr>
                            ...
                            <td><b>
                                    {{!is_null($injury->insuranceCompany)?$injury->insuranceCompany->name:'---'}}</b>
                            </td>
                            <td></td>
                            <td></td>
                            <td></td>
                        ...
                        <tr>
                            ...
                            <td><span>
                                        <input type="checkbox"
                                                {{$injury->status->injury_group_id==3?' checked':''}}
                                        >Kradzież</span></td>
                            <td><span>
                                        <input type="checkbox"
                                               {{$injury->status->injury_group_id==1?' checked':''}}
                                                >Kasacja</span></td>
                            <td><span>
                                        <input type="checkbox"
                                               {{$injury->status->injury_group_id==2?' checked':''}}
                                                >Cześciowa</span></td>
                            <td></td>
                            <td></td>
                        </tr>
                        <tr>
                            ...
                            <td><b>{{$injury->injuryPolicy->nr_policy}}</b></td>
                            <td></td>
                            <td></td>
                        ...
                        <tr>
                            ...
                            <td><b>
                                    {{!is_null($injury->injuryPolicy)?$injury->injuryPolicy->nr_policy:"---"}}</b></td>
                            <td></td>
                            <td></td>
                            <td style="background-color: rgb(243,248,253);"><span>Data i miejsce wystąpienia szkody
                                            </span></td>
                            <td><b>
                                    {{$injury->date_event.' '.$injury->event_post.' '.$injury->event_street.' '
                                    .$injury->event_city}}</b></td>
                        </tr>
                        <tr>
                            <td style="background-color: rgb(243,248,253);"><span>Odbiorca odszkodowania
                                            </span></td>
                            <td><span>
                                        <input type="checkbox" {{$injury->receive_id == 3?'checked':''}}> Leasingobiorca*
                                </span></td>
                            <td><span>
                                        <input type="checkbox" {{$injury->receive_id ==
                                        1?'checked':''}}>Warsztat</span></td>
                            <td></td>
                            <td></td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <b>{{!is_null($branch)?$branch->street.' '.$branch->city:"---"}}</b>
                            </td>
                            <td></td>
                            <td></td>
                            <td style="background-color: rgb(243,248,253);"><span>Kod
                                            </span></td>
                            <td><b>{{!is_null($branch)?$branch->code:"---"}}</b></td>
                        </tr>
                        </tbody>
                    </table>
                    ...
                    <div class="row" style="padding-bottom: 1cm; padding-top: 0.5cm">
                        <div class="column">
                        ...
                        <div class="column" style="margin-top: 15px; margin-right: 1cm; margin-bottom: 0.5cm">
                            <table style="width:100%; height:120%; border: 1px solid black">
                    ...
                    <span style="font-size: 10px; line-height: 1.1">
                    ...
                    <div style="font-size: 6.0pt; line-height: 1.1;color:rgb(66,63,61);"><b><br>Szanowni Państwo</b>,
                        ...
                        spełniającego kryteria jakości. Zapewniamy oryginalne części i gwarancje producenta, • 100 %
