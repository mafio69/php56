...
<div id="body">
    ...
    <div class="page"  id="content">
        ...
        <div style="margin-top: 35pt; font-size: 9pt; font-weight: bold;">
        ...
        <div style ="margin-top:25pt; font-size:9pt; text-align:justify;text-justify:inter-word;  line-height: 10pt;">
            ...
            <p style="margin-top: 20px;">
                Informujemy, iż leasingobiorca w/w pojazdu na mocy umowy leasingu zobowiązany jest do pokrycia kosztów naprawy:<br/>
                - w części, za którą nie odpowiada zakład ubezpieczeń,<br/>
                - w całości, jeżeli zakład ubezpieczeń odmówi wypłaty odszkodowania.
            </p>
