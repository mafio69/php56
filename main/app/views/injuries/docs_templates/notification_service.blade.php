    ...
    <table>
        <tr>
            ...
            <td style="text-align: right;">
                {{ checkIfEmpty('13', $ideaA) }}, {{date('d-m-Y')}}
            </td>
        </tr>
    </table>
</div>
<div id="footer_basic" style="bottom: 90px;">
    @if($vehicle->cfm == 1)
    ...
    <div class="page"  id="content">
        ...
        <div style="font-size: 7pt;">
            ...
            <table style="width: 100%; font-size: 9pt; font-weight:normal; margin-top:5px;">
                ...
                <tr>
                    <td width="200pt">{{ (isset($ideaA[5])) ? $ideaA[5] : '' }}</td>
                    <Td style="text-align: right;"></td>
                </tr>
            </table>

            <table style="font-size:12pt; margin-top:20pt; font-weight:bold;" align="center">
            ...
            <table style="width: 100%; font-size: 8pt; font-weight:normal;">
                <tbody>
                ...
                <tr >
                    ...
                    <td style="width:25%;">{{ $vehicle->brand }} {{ $vehicle->model }}</td>
