    ...
    @if($owner->id == 2)
        <div id="footer" class="footer-vb" >
            <table style="width: 100%; color:grey;">
                <tr>
                    <td colspan="3" style="color:#5892d1; font-size: 8pt;">
                        <img src="templates-src/phone.png" style="height: 14px; margin-top: 3px;"/>
                        {{ checkIfEmpty('11', $ideaA) }}
                    </td>
                </tr>
                <tr style="font-size: 5pt;">
                    <td style="padding-top: 5px; width: 270px;" ><strong>IL2 Leasing Sp. z o.o.</strong></td>
                    <Td>T: {{ checkIfEmpty('5', $ideaA) }}</td>
                    <Td>NIP: {{ checkIfEmpty('8', $ideaA) }}</td>
                </tr>
                <tr style="font-size: 5pt;">
                    <td>(dawniej Idea Leasing Spółka z ograniczoną odpowiedzialnością S.K.A.)</td>
                    <Td width="85px">F: {{ checkIfEmpty('6', $ideaA) }}</td>
                    <Td >REGON: {{ checkIfEmpty('15', $ideaA) }}</td>
                </tr>
                <tr style="font-size: 5pt;">
                ...
                <tr style="font-size: 5pt;">
                    <Td>{{ checkIfEmpty('3', $ideaA) }} {{ checkIfEmpty('13', $ideaA) }}</td>
                    <td colspan="2"></td>
                </tr>
            </table>
        </div>
    @else
        <div id="footer" class="footer-vb" >
            <table style="width: 100%; color:grey;">
                ...
                <tr style="font-size: 5pt;">
                    <td colspan="3" style="padding-top: 5px;" ><strong>{{ checkIfEmpty('1', $ideaA) }}</strong></td>
                </tr>
                <tr style="font-size: 5pt;">
                    <Td>{{ checkIfEmpty('2', $ideaA) }}</td>
                    <Td>T: {{ checkIfEmpty('5', $ideaA) }}</td>
