...
<div id="body">
    ...
    <div class="page"  id="content">
        ...
        <div style="font-size: 7pt; width: 100%;">
            ...
            <table style="width:100%; font-size:9pt; margin-top:0pt;  font-weight:normal;" >
                <tr>
                    <td style="text-align: left; width: 8.2cm;">{{ $owner->name }}</td>
                    <td></td>
                </tr>
                <tr>
                    <td style="text-align: left;width: 8.2cm;">{{ $owner->street }}</td>
                    <Td></Td>
                </tr>
                <tr>
                    <td style="text-align: left;width: 8.2cm;">{{ $owner->post }} {{ $owner->city }}</td>
                    <td></td>
                </tr>
                <tr>
                    <td style="text-align: left;width: 8.2cm;">cfm@cas-auto.pl</td>
                    <td></td>
                </tr>
            </table>
        ...
        <div style ="margin-top:10pt; font-size:9pt; text-align:justify;text-justify:inter-word;  line-height: 10pt;">
            ...
            <p style=" margin-top: 40px; font-weight: bold;">
                Decyzję o wypłacie odszkodowania prosimy przesłać na adres cfm@cas-auto.pl
            </p>
            <p style=" margin-top: 40px; ">
                W razie jakichkolwiek wątpliwości prosimy o kontakt telefoniczny pod nr tel. 22 666 42 82 w. 2 lub e-mail: cfm@cas-auto.pl
            </p>
        </div>
