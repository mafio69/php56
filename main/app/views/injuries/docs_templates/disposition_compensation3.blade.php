...
<div class="body content body-margin-big">
    <div class="t-body t-body-size-16">
        ...
        <p class="block text-left"><b>
                Dotyczy: szkoda komunikacyjna numer {{ $injury->injury_nr }} z dnia {{ $injury->date_event }}r.
                <br/>
                pojazd {{ checkObjectIfNotNull($injury->vehicle->brand, 'name', $injury->vehicle->brand)}} {{ checkObjectIfNotNull($injury->vehicle->model, 'name', $injury->vehicle->model)}}; nr rejestracyjny {{ $injury->vehicle->registration }}
                <br/>
        ...
        <p class="block text-justify">{{ (isset($ideaA[1])) ? $ideaA[1] : '---' }} z siedzibą w {{ (isset($ideaA[13])) ? $ideaA[13] : '---' }} przy {{ (isset($ideaA[2])) ? $ideaA[2] : '---' }} będąc właścicielem w/w pojazdu zwraca się z prośbą o przekazanie wypłaty odszkodowania na konto:   </p>
        ...
        <p class="small-block ">Wyrażamy zgodę na kosztorysowe rozliczenie szkody. Niniejszym anulujemy poprzednie upoważnienie. </p>
        ...
        <p class="text-left">W razie jakichkolwiek wątpliwości prosimy o kontakt telefoniczny 801 199 199 w. 5  lub email:<a
                    href="mailto:szkody@ideagetin.pl">szkody@ideagetin.pl</a>.</p><br/><br/>
