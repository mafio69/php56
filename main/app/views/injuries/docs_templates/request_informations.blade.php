    ...
    <div class="page"  id="content">
        ...
        <div style ="margin-top:30pt; font-size:9pt; text-align:justify;text-justify:inter-word;">
            ...
            <p style="text-indent:30px; margin-top: 30pt;">
                Z związku z w/w szkodą komunikacyjną zwracamy się z uprzejmą prośbą o zapoznanie się z treścią załączonego pisma i udzielenie wszelkich informacji mających na celu zakończenie procesu likwidacji <br/>w/w szkody.
            </p>
            <p style="margin-top: 20px; ">
                Dokumenty proszę kierować bezpośrednio do Towarzystwa Ubezpieczeniowego likwidującego szkodę.
            </p>
            <p style=" margin-top: 20px;">
