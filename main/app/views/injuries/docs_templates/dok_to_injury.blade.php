...
<div id="body">
    ...
    <div class="page"  id="content">
        ...
        <div style ="text-indent:30px; margin-top:30pt; font-size:9pt; text-align:justify;text-justify:inter-word;  line-height: 10pt;">
            <p >
                W związku z w/w szkodą komunikacyjną zakwalifikowaną jako całkowita {{ checkIfEmpty('1', $ideaA) }} z siedzibą we {{ checkIfEmpty('13', $ideaA) }} przy {{ checkIfEmpty('2', $ideaA) }} przesyła poniższe dokumenty niezbędne do zakończenia procesu likwidacji szkody:
            </p>
