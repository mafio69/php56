...
<head>
    ...
    <title>Potwierdzenie zgłoszenia szkody do systemu</title>
...
<table cellspacing="0" cellpadding="0" border="0" >
    <tr>
        <td align="center" style="text-align: center;">
            <table style="width:100%;" cellspacing="0" cellpadding="3" class="container">
                <tr >
                    <td >
                        <h3 style="text-align: center; color: #808080;">Potwierdzenie zgłoszenia szkody w systemu IdeaLeasing</h3>
                        <hr>
                    </td>
                </tr>
            </table>
    ...
    <tr>
        <td bgcolor="#FFFFFF" align="center">
            <table style="width:100%;" cellspacing="0" cellpadding="3" class="container">
                <tr>
                    <td>
                        Przez aplikację mobilną IdeaLeasing została zgłoszona szkoda
                        <?php if(isset($registration)){?>
                        dla samochodu o nr rejestracyjnym: <b><i><?php echo $registration;?></i></b>
                        <? }?>
                        <?php if(isset($nr_contract)){?>
                        dla umowy nr: <b><i><?php echo $nr_contract;?></i></b>
                        <? }?>
                    </td>
                </tr>
                <tr>
                    <td>
                        W celu potwierdzenia zgłoszenia prosze kliknąć w poniższy przycisk:
                    </td>
                </tr>
                <tr>
                    <Td style="text-align: center;">
                        <a href="<?php echo $confirmation_url;?>" class="btn btn-primary">potwierdź zgłoszenie szkody</a>
                    </Td>
                </tr>
            </table>
        </td>
        ...
        <td bgcolor="#FFFFFF" align="center">
            <table style="width:100%;" cellspacing="0" cellpadding="3" class="container">
                <tr>
                    <td>
                        <hr>
                        <p><img src="<?php echo $message->embed($logo); ?>" style="height:35px;"/></p>
                    </td>
                </tr>
            </table>
        </td>
