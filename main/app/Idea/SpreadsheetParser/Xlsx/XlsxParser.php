...
class XlsxParser
{
    ...
    */
     ...
     */
    const ARCHIVE_CLASS = 'Idea\SpreadsheetParser\Xlsx\Archive';

    /**
     * @staticvar string Relationships class
     */
    const RELATIONSHIPS_CLASS = 'Idea\SpreadsheetParser\Xlsx\Relationships';

    /**
     * @staticvar string RowBuilder class
     */
    const ROW_BUILDER_CLASS = 'Idea\SpreadsheetParser\Xlsx\RowBuilder';

    /**
     * @staticvar string RowIterator class
     */
    const ROW_ITERATOR_CLASS = 'Idea\SpreadsheetParser\Xlsx\RowIterator';

    /**
     * @staticvar string SharedStrings class
     */
    const SHARED_STRINGS_CLASS = 'Idea\SpreadsheetParser\Xlsx\SharedStrings';

    /**
     * @staticvar string Styles class
     */
    const STYLES_CLASS = 'Idea\SpreadsheetParser\Xlsx\Styles';

    /**
     * @staticvar string ValueTransformer class
     */
    const VALUE_TRANSFORMER_CLASS = 'Idea\SpreadsheetParser\Xlsx\ValueTransformer';

    /**
     * @staticvar string Spreadsheet class
     */
    const WORKBOOK_CLASS = 'Idea\SpreadsheetParser\Xlsx\Spreadsheet';
