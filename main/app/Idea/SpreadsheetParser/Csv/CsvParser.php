...
namespace Idea\SpreadsheetParser\Csv;
...
class CsvParser
{
     ...
     */
    const WORKBOOK_CLASS = 'Idea\SpreadsheetParser\Csv\Spreadsheet';

    /**
     * @staticvar string RowIterator class
     */
    const ROW_ITERATOR_CLASS = 'Idea\SpreadsheetParser\Csv\RowIterator';
