...
namespace Idea\Companies\Imports;

use Config;
use Excel;

class ImportCompaniesGuardians extends \Idea\Vmanage\Imports\BaseImporter
{
    public function __construct($filename)
    {
        $path = Config::get('webconfig.WEBCONFIG_UPLOADS_FOLDER') . '/imports/companies/';
