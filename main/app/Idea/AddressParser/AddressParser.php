...
class AddressParser {
    ...
    */
     ...
     *
     * @param string $txt
     * @return number higher value if string is closer to street patterns
     * @internal param string $txt to check
     */
     ...
     * @return array containing structured address if parsing was successfull togather with ORIGINAL value or partial structure in case of problems
     */
