...
namespace Idea\Reports\InsurancesReports\Refunds;
...
class EuropaReport implements ReportsInterface{
    ...
    private function generateSheet($excel)
    {
        ...
        LeasingAgreementInsurance::where('insurance_company_id',$this->params['insurance_company_id'])
            ...
            })->with('leasingAgreement', 'refundedInsurance', 'leasingAgreement.objects', 'leasingAgreement.client', 'leasingAgreement.insurance_group_row.rate')
