                ...
                ->chunk(500, function($injuries) use (&$handle){
                    ...
                    foreach($injuries as $injury)
                    {
                        $row = [
                            ...
                            \Config::get('definition.insurance_options_definition.'.$injury->object->gap),
...
//            return 'częściowa';
    ...
    private function endDate($injury,$files){
      ...
      if(!$end_date){
        if(!is_null($injury->date_end) && in_array($injury->step, [-7,15,16,17,19,21,23,24,25,26,34,35,37,44,45,46])){
