...
class OrderReport extends BaseReport implements ReportsInterface, ReportsCsvInterface{
                ...
                ->chunk(200, function($injuries) use (&$handle){
                    ...
                    foreach ($injuries as $k => $injury) {
                        ...
                        $row = array(
                            ...
                            $this->status($injury), //$injury->status->name
                            $processingType,
                            $injuryType,
                            ...
                            ($injury->dsp_notification == 1) ? 'TAK' : 'NIE',
                            ($injury->vindication == 1) ? 'TAK' : 'NIE',
                        );
